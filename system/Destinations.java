...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[] {"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Season Hotel", "Radison Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breez Blow Hotel", "The Taj Hotel", "HappyMorning Hotel","River View Hotel"};
